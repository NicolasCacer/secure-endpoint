...
Realizar login con este endpoint:  
> [https://secure-routing-thepaticos.netlify.app/login](https://secure-routing-thepaticos.netlify.app/login)  

Reemplazar `/login` por `/users`, `/products` y `/orders`. Utilizar el authToken en autenticación tipo Bearer Token. (Se utilizó postman para probar el endpoint local y desplegado)
